---
description: Initialize session context by reading key project files
---

Read the following files to understand the current project state and design decisions:
